...
function printHeader() {
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('     [ HEALTH CHECK ] POLYMARKET BOT');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
function printRecommendations(result: any) {
    ...
    if (result.checks.rpc.status === 'error') {
        issues.push('[ERROR] RPC Endpoint Failed');
    ...
    if (result.checks.balance.status === 'error') {
        issues.push('[ERROR] Zero USDC Balance');
        ...
        console.log(`${colors.yellow}${colors.bright}\n[WARNING] Low Balance Warning:${colors.reset}`);
    ...
    if (result.checks.polymarketApi.status === 'error') {
        issues.push('[ERROR] Polymarket API Failed');
    ...
    if (issues.length === 0) {
        ...
        console.log(`${colors.red}${colors.bright}\n[WARNING] ${issues.length} Issue(s) Found${colors.reset}`);
...
const main = async () => {
    try {
        printHeader();
        console.log(`${colors.yellow}[INFO] Running diagnostic checks...${colors.reset}\n`);
        ...
        console.error(`\n${colors.red}${colors.bright}[ERROR] Health Check Error${colors.reset}\n`);
